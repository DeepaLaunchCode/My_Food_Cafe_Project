...
VALUES ('John Doe', 'john.doe@example.com', '+15551234567');

-- Insert a sample menu item
INSERT INTO `menu_item` (`name`, `description`, `price`, `category`)
VALUES ('Classic Burger', 'A juicy beef patty with lettuce, tomato, and our special sauce.', 12.99, 'Main Course');
...
VALUES (1, 'xxxx-xxxx-xxxx-1234', '12/25', '123', 25.98, NOW());
...
VALUES ('+15551234567', 'Hi John Doe, your order #1 for $25.98 has been placed. Thank you!', 'SENT', NOW());
